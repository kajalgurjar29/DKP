    ...
    <>
      <div className='flex h-screen w-screen'>
        ...
        <div className='pb-6 bg-gray-100 flex-1 overflow-auto'>
          ...
          <h2 className="  text-2xl font-bold ml-5">Add New Rules</h2>
          <div className='Auction-edit mr-80'>
            ...
            <div className="mb-4  dropdown-container ml-5 pt-5 ">
              ...
              {isDropdownOpen && (
                <div className="absolute  bg-white border mt-1 rounded-md shadow-md">
                  {roles.map((role, index) => (
                    <div
                      key={index}
                      className="p-2 hover:bg-gray-100 cursor-pointer w-96 "
                      onClick={(e) => {
                        e.stopPropagation();
            ...
            <div className="mb-4 ml-5 flex ">
              <input
                ...
                onChange={(e) => setRole(e.target.value)}
                placeholder="Points"
                className="w-18 p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <div>
