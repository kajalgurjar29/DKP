...
function Users({ userRole }) {
  ...
  const [pools, setPools] = useState([
    ...
    { id: 1, name: "Excalibur Sword", UserName: "username1893", UserRole: "Raid Leader" },
    { id: 2, name: "Excalibur Sword", UserName: "username1893", UserRole: "Raid Leader" },
    { id: 3, name: "Excalibur Sword", UserName: "username1893", UserRole: "Raid Leader" },
    { id: 4, name: "Excalibur Sword", UserName: "username1893", UserRole: "Raid Leader" },
    { id: 5, name: "Excalibur Sword", UserName: "username1893", UserRole: "Raid Leader" },
    { id: 6, name: "Excalibur Sword", UserName: "username1893", UserRole: "Raid Leader" },

  ]);
  const [isOpen, setIsOpen] = useState(false);
  const roles = ["Raid Leader", "Member", "Applicant"];
          ...
          <div>
            <div className="p-4 rounded-lg shadow-md pt-8">
              <div className="pool-search flex justify-between items-center mb-4 h-20 w-full rounded-xl">
                ...
                <Link to="/AddUsers">
                  <button className="Create-Pool text-white px-4 py-2 ml-2 rounded-lg">+ Create Users</button></Link>
                    ...
                    <tr key={pool.id} className="border-t hover:bg-gray-100 text-sm">
                      ...
                      <div className="relative">
                        ...
                        >
                          ...
                          <span className="p-2">{userRole || "Select Role"}</span>
                        </div>
                      </div>
                      {isOpen && (
                        <div className="relative left-0 mt-2 w-40 bg-white border rounded-lg shadow-lg">
                          {roles.map((role) => (
                            <div
                              key={role}
