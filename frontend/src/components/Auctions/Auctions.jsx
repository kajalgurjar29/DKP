  ...
  const [pools, setPools] = useState([
    {
      ...
      Description: "Sword with +50 attack.",
      EventID: "EVT-001",
      Bids: "15",
      WinnerID: "204",
      FinalBid: "500 DKP",
          ...
          <div className="pool-search flex flex-col md:flex-row justify-between items-center mb-4 h-auto w-full rounded-xl p-5">
            ...
            <div className="flex gap-2 mt-2 md:mt-0">
              <Link to="/Auctionsview">
                <button className="Create-Pool text-white px-4 py-2 rounded-lg">
                  + Create Auctions
                </button>{" "}
              </Link>
                  ...
                  >
                    ...
                    <td className="p-2 relative">
                      <button
                        onClick={(e) => {
                          setOpenMenuId(
                            openMenuId === pool.id ? null : pool.id
                          );
                        }}
                      ...
                      {openMenuId === pool.id && (
                        <div
                          ...
                          style={{
                            ...
                            marginTop:
                              index >= pools.length - 2 ? "-10px" : "10px",
                          }}
                        >
                          <Link
                            to="/Auctionsview"
