...
function Pools() {
  ...
  const [pools, setPools] = useState([
    { id: 1, name: "Raid Pool", type: "PvE", description: "Description", users: 5 },
    { id: 2, name: "PvP Pool", type: "PvP", description: "Description", users: 4 },
    { id: 3, name: "Resource Pool", type: "Resource", description: "Description", users: 2 },
    { id: 4, name: "Auction Pool", type: "Auction", description: "Description", users: 4 },
    { id: 5, name: "General Pool", type: "Universal", description: "Description", users: 5 },
    { id: 6, name: "General Pool", type: "Universal", description: "Description", users: 5 },
    { id: 7, name: "General Pool", type: "Universal", description: "Description", users: 5 },
    { id: 8, name: "General Pool", type: "Universal", description: "Description", users: 5 },
  ]);
        ...
        <div className="p-4 rounded-lg shadow-md pt-8">
          <div className="pool-search flex justify-between items-center mb-4 h-20 w-full  rounded-xl">
            ...
            <div className="flex gap-2 mr-5">
              <Link to="/Edit">
              <button className="Create-Pool text-white px-4 py-2 ml-2 rounded-lg">+ Create Pool</button></Link>
            ...
            <tbody>
              {pools.map((pool, index) => (
                <tr key={pool.id} className="border-t hover:bg-gray-100 text-sm">
                  ...
                  <td className="p-2 font-semibold">{pool.users}</td>
